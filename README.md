...
| **图片工具** | 批量压缩（JPG/PNG/WebP）、缩放、旋转翻转、文字/图片水印、**长图拼接**、**证件照排版**（一寸/二寸/护照按 300dpi 排满相纸）、**贴图 / 遮挡标注**（单张交互式：马赛克打码、涂抹遮挡、贴图盖章、框选复制、裁剪、全屏编辑） |
...
> **连不上 GitHub？** 源码与版本说明有 [Gitee 国内镜像](https://gitee.com/ruai0/lantai)（与 GitHub 自动同步，仅供浏览/克隆）；安装包下载地址仍以 GitHub Releases 为准，也可向管理员索取离线包。
